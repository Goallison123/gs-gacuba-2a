...
- **Active Core Production Pages**:
  ...
  - `SportsPage` (`src/pages/SportsPage.tsx`): Curved orange hero banner with three-line impact headline (*"Build strength. Build discipline. Build champions."*), stat metrics bar (15+ Sports, 3 Teams, 20 Awards), layered athlete composite (basketball, cultural troupe dancer, diving goalkeeper), 3 discipline cards (Basketball, Football, Athletics), *"Beyond the Game"* values section with interactive video highlights reel modal, and golden-orange call to action banner.
