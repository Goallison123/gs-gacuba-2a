...
export const searchDatabase: SearchItem[] = [
  ...
  {
    id: 'sports-main',
    title: 'Sports & Entertainment at GS Gacuba II A',
    subtitle: 'Build Strength, Discipline & Champions',
    category: 'student-life',
    categoryLabel: 'Sports',
    description: 'Explore basketball, football, athletics, and cultural dance troupe programs inspiring teamwork and excellence.',
    keywords: ['sports', 'entertainment', 'games', 'athletics', 'basketball', 'football', 'soccer', 'sports page', 'champions', 'teams', 'trophies', 'tournaments'],
    page: 'sports',
    badge: '15+ Sports',
  },
  {
    id: 'sports-basketball',
    title: 'Basketball Program & Courts',
    subtitle: 'Building Strategy, Agility & Team Spirit',
    category: 'student-life',
    categoryLabel: 'Sports',
    description: 'Competitive basketball training, boys and girls squads, and inter-school championship participation.',
    keywords: ['basketball', 'hoop', 'court', 'basketball team', 'sports', 'games'],
    page: 'sports',
    badge: 'Boys & Girls',
  },
  {
    id: 'sports-football',
    title: 'Varsity Football & Soccer Pitch',
    subtitle: 'Strength, Endurance & Teamwork',
    category: 'student-life',
    categoryLabel: 'Sports',
    description: 'Full-size football pitch with dedicated coaching for regional secondary school cup tournaments.',
    keywords: ['football', 'soccer', 'pitch', 'goalkeeper', 'football team', 'match'],
    page: 'sports',
    badge: 'Regional Cup',
  },
  {
